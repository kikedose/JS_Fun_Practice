This is a fork of https://github.com/zero-to-mastery/JS_Fun_Practice 
...
1. Run <code>yarn install</code> to install the dependencies.
2. Run <code>yarn dlx @yarnpkg/sdks vscode</code> or <code>yarn dlx @yarnpkg/sdks vim</code> for linting and formatting support.
3. Change the <code>filename</code> variable in <code>test/tests.js</code> to the name of your solution file.
4. Make sure your solution file is in the <code>Solutions</code> folder.
5. Make sure your function names match the ones listed below as you're coding them.
6. At the bottom of your solution file, export
<code>module.exports = {
    identity,
    addb,
    subb,
...
7. You can comment out any function names in the <code>module.exports</code> that you haven't written yet, but a lot of the tests depend on previous functions to run properly so it's safer to write the functions in order.
8. Finally, <code>yarn test</code> to run the tests.
